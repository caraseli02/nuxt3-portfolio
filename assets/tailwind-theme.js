...
export default {
    ...
    global: {
      ...
      help: 'text-xs dark:text-gray-50 text-gray-500',
    ...
    'family:dropdown': {
      ...
      inner: 'max-w-md relative flex ring-1 ring-gray-400 focus-within:ring-indigo-500 focus-within:ring-2 rounded mb-1 formkit-disabled:focus-within:ring-gray-400 formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-blue-500',
    ...
    textarea: {
      ...
      input: 'block w-full h-32 px-3 py-3 border-none text-base dark:text-white text-gray-700 placeholder-gray-400 focus:shadow-outline',
    },
