<template>
  <div class="bg-body text-white font-poppins pb-12">
    ...
    <div class="container mt-16 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
      <div class="w-full flex justify-between flex-wrap md:flex-nowrap">
        ...
        <div class="flex flex-wrap lg:ml-20 justify-center md:justify-start max-w-xl mt-0 md:my-36 z-10">
          <h1 class="font-bold text-5xl md:text-6xl lg:text-7xl text-center md:text-left">
            Building<span class="bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-500">
              <br> beautiful UI
            </span> experiences.
          </h1>
          <div class="w-full flex justify-center md:justify-start">
            <button
              class="px-8 py-4 border border-slate-300 bg-transaprent text-slate-200 font-bold mt-12 flex items-center space-x-3 rounded-full">
              <div>
    ...
    <div class="container mt-64 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
      <section class="w-full">
        ...
        <p class="section-paragraph">I’ve had the pleasure of working with multiple Fortune 500 companies, designing and
          implementing both frontend and backend.</p>
        ...
        <div class="space-y-12 my-16">
          <div
            ...
            <div class="flex flex-wrap justify-center text-center lg:text-left lg:block">
              ...
              <p class="text-secondary">I’ve had the pleasure of working with multiple Fortune 500 companies, designing
                and implementing both frontend and backend.</p>
            </div>
        ...
        <div class="w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-24">
          ...
          <div class="mt-12">
            ...
            <div class="flex mt-20 space-x-6">
              <!-- Skype -->
              <a href="#">
                <svg class="w-8 h-8 lg:w-12 lg:h-12" width="50" height="50" viewBox="0 0 50 50" fill="none"
              ...
              <!-- Twitter -->
              <a href="#">
                <svg class="w-8 h-8 lg:w-12 lg:h-12" width="42" height="42" viewBox="0 0 42 42" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
