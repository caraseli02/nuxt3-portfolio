      ...
      <div v-if="targetIsVisible"
        ...
        <NuxtLink class="overflow-hidden aspect-[10/16]" :to="`/projects/${project.id}`">
          <nuxt-picture format="avif,webp"
            ...
            :src="project.img" :alt="project.title" height="336" sizes="md:200px lg:336" />
        </NuxtLink>
        <div class="p-5 flex flex-col justify-between sm:block">
          ...
          <NuxtLink :to="`/projects/${project.id}`"
            ...
            Read more
            <svg class="w-3.5 h-3.5 ml-2 transform group-hover:translate-x-1 transition-all" aria-hidden="true"
