      ...
      <div>
        ...
        <div class="flex">
          <div class="flex items-center mr-10">
            <Icon name="clarity:clock-line" class="w-4 h-4 text-ternary-dark dark:text-ternary-light" />
            <span class="
                font-general-medium
                ml-2
                leading-none
          ...
          <div class="flex items-center">
            <Icon name="solar:tag-outline" class="w-4 h-4 text-ternary-dark dark:text-ternary-light" />
            <span class="
                font-general-medium
                ml-2
                leading-none
